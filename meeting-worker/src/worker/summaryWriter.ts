...
export interface MeetingTask {
  ...
  description: string; // 1-2 предложения контекста из обсуждения, или пустая строка
}
...
Верни ТОЛЬКО JSON-объект (без markdown-блоков, без объяснений):
{
  ...
  "tasks": [
    { "title": "...", "assignee": "имя или пустая строка", "deadline": "ISO-8601 или пустая строка", "description": "1-2 предложения: суть задачи и контекст из обсуждения, или пустая строка" }
  ]
}
